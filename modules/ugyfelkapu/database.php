...
class DatabaseConnection{
	...
	final function connect(){
		...
		//csatlakozáskor visszakapok egy resource típust a mysql kapcsolatra, ezt megõrizzük
  ...
  /**
  return: 
    - ha van visszatérõ adat, akkor az eredmény sorai array-ben, auto inkrementált indexeléssel: array(0=>array(...), 1=>array(...) ) 
    - ha nincs visszatérõ adat, akkor true
